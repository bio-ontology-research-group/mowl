...
@deprecated(
    reason = "Importing this method using :func:`mowl.datasets.build_ontology.insert_annotations` will be removed in version 1.0.0. Consider using :func:`mowl.ontology.extend.insert_annotations` instead.",
    version = '0.1.0'
)
