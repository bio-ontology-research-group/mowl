...
class PPIYeastDataset(RemoteDataset):
    """
    This dataset represent protein--protein interactions on the yeast species.  The data used for \
...
class PPIYeastSlimDataset(PPIYeastDataset):
    """
    Reduced version of :class:`PPIYeastDataset`. Tranining ontology is built from the Slim Yeast \
    subset of Gene Ontology.
    """
