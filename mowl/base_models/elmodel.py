...
class EmbeddingELModelOld(EmbeddingModel):
    ...
    def load_data(self, extended=True):
        ...
        if self.dataset.testing is not None:
        ...
        training_nfs = self.load_normal_forms(self.training_axioms, self.classes_index_dict,
                                              self.relations_index_dict, extended)
        validation_nfs = self.load_normal_forms(self.validation_axioms, self.classes_index_dict,
                                                self.relations_index_dict, extended)
        testing_nfs = self.load_normal_forms(self.testing_axioms, self.classes_index_dict,
                                             self.relations_index_dict, extended)
