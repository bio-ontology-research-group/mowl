...
def load_valid_subsumption_data(valid_data_file, classes):
    data = []
    with open(valid_data_file, 'r') as f:
        for line in f:
            it = line.rstrip("\n").split("\t")
            ...
            id1 = "<http://purl.obolibrary.org/obo/" + id1 + ">"
            id2 = "<http://purl.obolibrary.org/obo/" + id2 + ">"
    ...
    print(f"Number of datapoints loaded: {len(data)}")
    return data
