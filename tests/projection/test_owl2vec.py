...
class TestOwl2VecStar(TestCase):
    ...
    def test_project_family_ontology(self):
        ...
        # exists_some_individual1 = data_factory.getOWLObjectSomeValuesFrom(role2, named_individual1.asOWLClass())
        ...
        superproperty_chain = data_factory.getOWLObjectProperty(IRI.create("http://superpropertyChain"))
        property_chain = ArrayList()
        property_chain.add(role1)
        property_chain.add(role2)
        axiom_rule_6_3 = data_factory.getOWLSubPropertyChainOfAxiom(property_chain, superproperty_chain)
        ...
        axiom_rule_9 = data_factory.getOWLObjectPropertyAssertionAxiom(role1, individual, individual2)
