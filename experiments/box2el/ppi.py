...
def main(dataset_name, embed_dim, batch_size,
    ...
    wandb_logger = wandb.init(entity="zhapacfp_team", project="ontoem", group=f"box2el_{dataset_name}", name=wandb_description)
    ...
    model_filepath = f"{model_dir}/box2el_{embed_dim}_{module_margin}_{loss_margin}_{learning_rate}.pt"
